...
- **Reproducible environments**: [.devcontainer/devcontainer.json](../../.devcontainer/devcontainer.json) + `uv.lock` mean anyone gets an identical environment, locally or in Codespaces, with one command (see exercise 00).
