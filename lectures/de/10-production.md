...
- **Reproduzierbare Umgebungen**: [.devcontainer/devcontainer.json](../../.devcontainer/devcontainer.json) + `uv.lock` bedeuten, dass jeder mit einem einzigen Befehl eine identische Umgebung erhält, lokal oder in Codespaces (siehe Lektion 00).
